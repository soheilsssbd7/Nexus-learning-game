...
**وضعیت فاز ۸ (به‌روز):** ۸.۱ ✅ · ۸.۲ ✅ · ۸.۳ ✅ · ۸.۴ ✅ · ۸.۵ ✅ ⇒ DoD فاز ۸ بسته شد ✓ — با این قیدِ صادقانه: چهار قرمزیِ `882af0c` در دو کامیتِ اصلاحی (`c60ce8c` پوستهٔ `SettingsMenu` + ممیزیِ `_add_label`، `f9c86a4` ترتیبِ انوتیشن) بسته شد ✓✗ و اثباتِ CI‌شان **در انتظارِ پوش** است (اتصالِ GitHub به این سندباکس درست وسطِ کار افتاد ⇒ «۴/۴» را تا دیدنِ لاگِ سبز ادعا نمی‌کنیم ✗✓). چک‌لیستِ دستگاه (اندازۀ واقعیِ ۴۸dp روی ۴٫۷ اینچ، فاصلۀ خطِ فارسی، لرزشِ haptic) در فاز ۱۰ می‌ماند ✓§۹/§۱۲.

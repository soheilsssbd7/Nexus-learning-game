...
می‌شوند — Godot 4 روی `layout_mode`/`anchors_preset` (فقط ویرایشگر) `load()` را می‌شکست.
...
> یادداشت اجرایی (۱۳۹۵-۰۹-۰۹): ADR-044 یک بند «فاز ۹» دارد که باز است — وقتی `modules/sync/`
